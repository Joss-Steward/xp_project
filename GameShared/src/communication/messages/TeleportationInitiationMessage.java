...
public class TeleportationInitiationMessage implements Message, Serializable
{
	 ...
	 * @param newPosition
	 *            the position in which the player should be placed when the
	 *            move is complete
	 */
	public TeleportationInitiationMessage(int playerId, String mapName,
	...
	{
		return "TeleportationInitiationMessage: playerID = " + playerId + " mapName = " + mapName + " position = " + position;
	}
