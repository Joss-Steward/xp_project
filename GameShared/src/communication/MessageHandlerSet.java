...
/**
 * Manages a set of MessageHandlers and the type of message each one can process and uses the appropriate one to process each message. It is important
 * to note that it can only store ONE handler for each message type.
 * @author merlin
 *
 */
public class MessageHandlerSet
{
	 ...
	 * @param class1 the type of message this handler should be used for
	 * @param handler the handler
	 */
	public void registerHandler(Class<? extends Message> class1,
	 ...
	 * @throws CommunicationException if there is not handler for the given type of message
	 */
