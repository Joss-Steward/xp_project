...
public class ClientPlayerQuestTest 
{
	...
	public void testClientPlayerQuestInitialization() 
	{
		...
		ClientPlayerQuest q = new ClientPlayerQuest(1, "title", "Test Quest 1", QuestStateEnum.HIDDEN, 42, 133, true, expireDate);
	...
	{
		ClientPlayerAdventure adventureOne = new ClientPlayerAdventure(1, "Test Adventure 1", 4, AdventureStateEnum.HIDDEN, false, true, "Henry",QuestStateEnum.AVAILABLE);
		ClientPlayerAdventure adventureTwo = new ClientPlayerAdventure(2, "Test Adventure 2", 4, AdventureStateEnum.HIDDEN, false, false, null,QuestStateEnum.AVAILABLE);
		ClientPlayerQuest q = new ClientPlayerQuest(1, "title", "Test Quest 1", QuestStateEnum.HIDDEN, 1, 2, true, null);
	...
	{
		ClientPlayerAdventure adventureOne = new ClientPlayerAdventure(1, "Test Adventure 1", 4, AdventureStateEnum.COMPLETED, true, true, "CEO:", QuestStateEnum.AVAILABLE);
		ClientPlayerAdventure adventureTwo = new ClientPlayerAdventure(2, "Test Adventure 2", 2, AdventureStateEnum.COMPLETED, true, false, null, QuestStateEnum.AVAILABLE);
		ClientPlayerQuest q = new ClientPlayerQuest(1, "title", "Test Quest 1", QuestStateEnum.FINISHED, 1, 2, true, null);
		q.addAdventure(adventureOne);
		q.addAdventure(adventureTwo);
		assertEquals(2, q.getAdventureList().size());
		return q;
	...
	{
		ClientPlayerAdventure adventureOne = new ClientPlayerAdventure(1, "Test Adventure 1", 10, AdventureStateEnum.HIDDEN, false, false, null, QuestStateEnum.AVAILABLE);
		assertEquals(1, adventureOne.getAdventureID());
		ClientPlayerAdventure adventureTwo = new ClientPlayerAdventure(2, "Test Adventure 2", 7, AdventureStateEnum.HIDDEN, false, true, "Liz", QuestStateEnum.AVAILABLE);
