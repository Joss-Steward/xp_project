...
public class OneChoiceScreenPopUp extends Group implements ScreenPopUp
{
	 ...
	 */
	public OneChoiceScreenPopUp(String header, String description, Stage stage, PopupBehavior behavior, PopUpDisplay display)
	{
	...
	public static class ExitDialog extends Dialog 
	{
		 ...
		 */
		public ExitDialog(String header, String description, Skin skin, PopupBehavior behavior, PopUpDisplay display, OneChoiceScreenPopUp parent)
		{
			super(header, skin);
