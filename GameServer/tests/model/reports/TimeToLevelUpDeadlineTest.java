...
public class TimeToLevelUpDeadlineTest
{
    ...
    public void testCreation()
    {
        ...
        TimeToLevelUpDeadlineReport report = new TimeToLevelUpDeadlineReport(PlayersForTest.MARTY.getPlayerID(), new GregorianCalendar(2016, 3, 4).getTime(), "freemerchant");
